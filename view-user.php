	...
	<div class="row sticky-wrapper">
		...
		<div class="col-lg-8 col-md-8 padding-left-30">
			...
			<!-- Listings Container / End -->
				<div>
				<ul class="tabs-nav">
					<li class="active"><a href="#tab1b">Job Poster Reviews</a></li>
					<li><a href="#tab2b">Job Bidder Reviews</a></li>
				</ul>
				</div>
				...
				<section class="comments listing-reviews">
					...
					<div class="tab-content" id="tab2b"><!-- Reviews -->
				<section style="display:none;" class="comments listing-reviews">
